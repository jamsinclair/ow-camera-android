...
The rest of the app is mostly unchanged from Open Camera, with additonal background logic for sending preview images and some minor tweaks to the user interface and strings.
