...
import com.github.jamsinclair.pebbleopencamera.MainActivity;
...
public class MyWidgetProvider extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int i=0; i<N; i++) {
			...
			if( sharedPreferences.getBoolean(MainActivity.getShowWhenLockedPreferenceKey(), true) ) {
	            ...
	            intent.setAction("com.github.jamsinclair.pebbleopencamera.LAUNCH_OPEN_CAMERA");
	...
	public void onReceive(Context context, Intent intent) {
	    ...
	    if (intent.getAction().equals("com.github.jamsinclair.pebbleopencamera.LAUNCH_OPEN_CAMERA")) {
	    	if( MyDebug.LOG )
