package com.github.jamsinclair.owcamera.CameraController;
	...
	public CameraFeatures getCameraFeatures() {
		...
		if( camera_features.is_zoom_supported ) {
			...
			try {
				...
				// this is from java.lang.Integer.invalidInt(Integer.java:138) - unclear if this is a bug in OW Camera for Pebble, all we can do for now is catch it
	    		if( MyDebug.LOG )
