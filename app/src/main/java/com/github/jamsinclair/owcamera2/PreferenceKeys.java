...
public class PreferenceKeys {
    ...
    public static final String CameraNoiseReductionModePreferenceKey = "preference_noise_reduction_mode"; // n.b., this is for the Camera driver noise reduction mode, not OW Camera 2 for Pebble's NR photo mode
