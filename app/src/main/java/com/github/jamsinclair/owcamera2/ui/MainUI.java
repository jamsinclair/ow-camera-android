package com.github.jamsinclair.owcamera2.ui;

import com.github.jamsinclair.owcamera2.MyApplicationInterface;
...
import com.github.jamsinclair.owcamera2.PreferenceKeys;
import com.github.jamsinclair.owcamera2.preview.ApplicationInterface;
...
public class MainUI {
    ...
    private void setPopupViewRotation(int ui_rotation, int display_height) {
        ...
        if( popup_view != null && popup_width > popup_view.getTotalWidth()*1.2  ) {
            ...
            // should fix it, rather than having to restart or pause/resume OW Camera 2 for Pebble.
    ...
    int getMaxHeightDp(boolean centred) {
        // ensure we have display for landscape orientation (even if we ever allow OW Camera 2 for Pebble
        Point display_size = new Point();
        main_activity.getApplicationInterface().getDisplaySize(display_size, true);
