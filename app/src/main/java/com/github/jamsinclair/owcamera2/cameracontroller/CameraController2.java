...
import com.github.jamsinclair.owcamera2.HDRProcessor;
...
public class CameraController2 extends CameraController {
    ...
    private boolean burst_for_noise_reduction; // chooses number of burst images and other settings for OW Camera 2 for Pebble's noise reduction (NR) photo mode
    ...
    public CameraFeatures getCameraFeatures() throws CameraControllerException {
        ...
        // support fast burst - and which OW Camera 2 for Pebble never allowed with Camera2 before 1.45).
        // Also may affect Samsung Galaxy A8(2018).
    ...
    public void autoFocus(final AutoFocusCallback cb, boolean capture_follows_autofocus_hint) {
        ...
        synchronized( background_camera_lock ) {
            ...
            if( focus_mode == null ) {
                ...
                // (unclear if OW Camera 2 for Pebble needs this, but just to be safe and consistent between camera APIs)
                if( MyDebug.LOG )
