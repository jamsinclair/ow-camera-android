...
public class VideoProfile {
    ...
    public void copyToMediaRecorder(MediaRecorder media_recorder) {
        ...
        // it's probably safe to always call setCaptureRate, but to be safe (and keep compatibility with old OW Camera 2 for Pebble versions), we only do so when needed
